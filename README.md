...
[![CI Status](https://travis-ci.org/iOSWizards/AwesomeData.svg?branch=0.3.5)](https://travis-ci.org/iOSWizards/AwesomeData)
...
```ruby
pod "AwesomeData", git: 'https://github.com/iOSWizards/AwesomeData.git', tag: '0.3.6'
```
