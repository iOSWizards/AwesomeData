...
Pod::Spec.new do |s|
  s.name             = 'AwesomeData'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AwesomeData.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'Evandro Hoffmann' => 'ehh85@yahoo.com.br' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/AwesomeData.git', :tag => s.version.to_s }
